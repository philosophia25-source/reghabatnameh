...
export const metadata: Metadata = {
  ...
  openGraph: { title: "ماده ۴۴ | رقابت‌نامه", description: "متن، شرح و آرای مرتبط با ماده ۴۴", url: "/laws/article-44", siteName: "رقابت‌نامه", locale: "fa_IR", type: "article", images: [{ url: "/og.jpg", width: 1200, height: 630, alt: "ماده ۴۴ | رقابت‌نامه" }] },
