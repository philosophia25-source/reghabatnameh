...
const canonical = "/laws/general-policies-44/article-45";

export const metadata: Metadata = {
  title: "ماده ۴۵",
  description: "متن و ساختار شرح تحلیلی ماده ۴۵ قانون اجرای سیاست‌های کلی اصل چهل‌وچهار قانون اساسی",
  alternates: { canonical },
  openGraph: { title: "ماده ۴۵ | رقابت‌نامه", description: "متن، ساختار شرح و آرای مرتبط با ماده ۴۵", url: canonical, siteName: "رقابت‌نامه", locale: "fa_IR", type: "article", images: [{ url: "/og.jpg", width: 1200, height: 630, alt: "ماده ۴۵ | رقابت‌نامه" }] },
