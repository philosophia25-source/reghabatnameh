...
export const article45Sections: Article45Section[] = [
  ...
  },
  {
    ...
    lead: "ترغیب، تحریک و یا وادار ساختن یک یا چند سهامدار، صاحب سرمایه، مدیر یا کارکنان یک بنگاه و یا شرکت رقیب از طریق اعمال حق رأی، انتقال سهام، افشاء اسرار، مداخله در معاملات بنگاهها و یا شرکتها یا روش‌های مشابه دیگر به انجام عملی که به ضرر رقیب باشد.",
  },
  {
    slug: "clause-ta",
    letter: "ط",
