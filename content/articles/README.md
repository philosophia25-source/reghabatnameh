# Published article provenance

The telecom article is reproduced from the owner-supplied published PDF, retained unchanged at `public/articles/competition-council-and-telecom-regulator.pdf`.

- PDF SHA-256: `7e5beb3521b4cd40129da0afc4adbd72ef7e93905477d1f6b2b0f5f1c8d008b7`
- DOI from the printed first page: `10.22034/qjplk.2024.1969.1770` (not `qiplk`).
- Bibliographic page range 189–212 follows the first-page metadata. The supplied file has 23 physical pages.
...
The article is linked only to existing relevant documents. Session numbers alone are not unique identifiers across institutions.
