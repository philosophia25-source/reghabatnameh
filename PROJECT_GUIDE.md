...
- ماده ۴۵ با متن کامل و نقشه ۳۶ بخشی شرح منتشر شده است. این نقشه شامل صدر ماده، یازده بند، بیست‌وسه جزء و تبصره بند «د» است
- هیچ صفحه شرح خالی برای ماده ۴۵ منتشر نشده است. با ورود نخستین شرح، مسیر پویای اجزای منتشرشده باید مانند مسیر ماده ۴۴ فعال شود
...
برای نخستین شرح ماده ۴۵، افزون بر مراحل بالا مسیر `app/(legal)/laws/general-policies-44/article-45/commentary/[part]/page.tsx` نیز باید با الگوی مسیر متناظر ماده ۴۴ ساخته شود. قالب محتوای ماده ۴۵ از قبل در `components/article-45-commentary.tsx` آماده است. پس از ورود نخستین متن، فقط بخش‌های دارای فایل واقعی در `generateStaticParams` قرار می‌گیرند و اجزای دیگر نباید صفحه عمومی داشته باشند.
